...
#memanggil data#
dataytri <- read_excel("E:\\skripsi\\PPN\\WordCloud\\Tweet For Sentiment.xlsx")
...
cStopwordID <- readLines("E:\\skripsi\\Plugin\\StopwordsID.txt")
...
write.csv(databersih, file = "E:\\skripsi\\PPN\\WordCloud\\BookwordCleandata.csv")
...
par(mar=rep(3,4))
a <- barplot(colSums(s),col=rainbow(15),ylab='count',main='Sentiment Analysis PPN 11%')
brplt <-a